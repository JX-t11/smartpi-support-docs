...
| **变更** | - 删除非烧录相关内容（STM32编程3节×200行、PWM控制20行、GPIO配置~350行、外设功能开发×3500行）<br>- 删除营销服务类内容（烧录服务×150行、文件获取教程×1400行、统计信息×800行）<br>- 删除项目管理内容（测试与样机管理×600行）<br>- 合并重复FAQ：CH340驱动(2→1)、TX/RX接反(2→1)、烧录工具问题(多个→统一)<br>- 重构为7个清晰分类，30条聚焦FAQ |
