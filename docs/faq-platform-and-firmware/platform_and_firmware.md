...
在生成固件文件时遇到服务器无法生成的问题，导致无法快速生成固件。
...
- 服务器问题通常是临时性的，不需要特殊处理
- 如果持续无法生成，可联系专业技术支持确认服务器状态
...
在使用语音模块时，希望在唤醒词唤醒语音芯片的同时，通过串口发送数据给主控MCU，以实现主控的同步唤醒。
...
模块价格较高，希望了解是否可以提供芯片+麦克风+扬声器的方案，以降低成本。同时需要了解模型转换固件的时间需求和英文翻译支持。
...
![固件生成失败界面](./img/1760604578832968f0b1a2cb55e.jpg)
...
![双MIC配置界面](./img/1767316927254669571dbf3e27e.jpg)
...
- [官方淘宝店铺](https://shop379208868.taobao.com/)
