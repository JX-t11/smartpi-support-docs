...
JX-A7T 作为机芯智能的新品已正式上线，该产品同时拥有离线指令与在线指令双重模式。其中，在线指令搭载大模型运行，为用户带来更智能、更高效的使用体验。目前产品的例程和文档已陆续上传至智能公元平台，为开发者提供完整的技术支持。
...
JX-A7T 是一款离在线语音AI大模型模组，集成语音芯片（CI1302）和WiFi芯片，支持离线唤醒识别和在线大模型对话功能。该产品同时拥有离线指令与在线指令双重模式，其中在线指令搭载大模型运行，为用户带来更智能、更高效的使用体验。
