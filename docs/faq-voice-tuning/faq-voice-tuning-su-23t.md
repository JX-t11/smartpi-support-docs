...
- **英文识别对发音标准性要求较高**：英文语音识别需要相对标准的发音，在多国用户或非英语母语用户场景下，由于口音和发音标准性差异，识别率可能会显著下降。如目标用户涉及多国或非标准英语发音环境，建议进行充分的实际测试验证，必要时考虑选择支持多语言定制的CI系列模块。

---

### SU-23T没有降噪模型，如何提高识别率？

**问题描述：**

SU-23T模块没有配置降噪模型，与CI-03T等模块相比识别效果接近，需要了解如何进一步提高SU-23T的识别率。

**解决方案：**

**1. 了解SU-23T的产品定位**

SU-23T是低功耗产品，在识别性能上相比CI-03T等标准功耗模块会相对较弱：

- SU-23T采用蜂鸟LPro超低功耗芯片
- 电池供电场景下功耗优化是主要设计目标
- 识别性能会受功耗限制

**2. 通过声学结构优化**

在没有降噪模型的情况下，可通过硬件声学设计提升识别效果：
...
- **识别灵敏度**：拉高识别灵敏度设置
- **命令词阈值**：在优化选项中调整命令词的阈值（默认0.5，适当降低可提高识别率）
- **唤醒灵敏度**：根据实际情况设置为"中"或"高"

**4. 命令词设计优化**

- **多写分词**：为每个命令词添加更多分词变体
- **避免相似发音**：不要使用发音过于相似的命令词
- **使用简洁明确的词汇**：4字左右命令词识别效果较好

**5. 使用环境建议**

- 保持环境相对安静
- 使用距离控制在0.5-1米范围
- 避免在强噪声环境（如电视、音响附近）使用

**注意事项：**

- SU-23T的识别率提升有物理限制，这是低功耗设计的权衡
- 如果对识别率要求较高，建议考虑CI-03T等标准功耗模块
- 声学结构优化需要实际测试验证效果
