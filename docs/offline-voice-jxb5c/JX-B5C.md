...
### 基本资料
- [原理图](basic-info/schematic.md) - 模组硬件原理图
- [规格书](basic-info/datasheet.md) - 详细技术规格参数

### 烧录资料
- [CH340驱动](flash/ch340-driver.md) - 串口驱动安装
- **烧录软件**
  - [蓝牙音乐部分](flash/flash-tool-bt.md)
  - [语音识别部分](flash/flash-tool-asr.md)
- [烧录文档](flash/flash-guide.md) - 详细烧录步骤说明
- **出厂固件**
  - [蓝牙音乐部分](flash/firmware-bt.md)
  - [语音识别部分](flash/firmware-asr.md)
- [串口调试](flash/serial-debug.md) - 串口调试工具使用

### 芯片资料
- [蓝牙音乐部分](chip-info/chip-bt.md) - 蜂鸟B芯片技术文档
- [语音识别部分](chip-info/chip-asr.md) - CI1302芯片技术文档

### 开发包
- [开发包资料](sdk/sdk.md) - SDK和开发工具下载

### 产品设计
- [产品结构声学规范](product-design/acoustic-design.md) - 产品结构设计指南
- [喇叭和咪头选型](product-design/speaker-mic.md) - 音频器件选型建议
...
#### 1. 环境搭建
- 安装 [CH340驱动](flash/ch340-driver.md)
- 下载烧录软件（蓝牙部分和语音识别部分）
- 准备串口调试工具
...
#### 3. 固件烧录
- 参考 [烧录文档](flash/flash-guide.md) 进行固件烧录
- 分别烧录蓝牙音乐部分和语音识别部分固件
...
4. 等待烧录完成后重启设备
  ...
  - [智能公元平台](https://platform.aimachip.com) - 在线开发平台
  - [官方帮助中心](https://help.aimachip.com/docs/offline_jxb5c) - 完整文档资料
  - [技术支持](mailto:support@aimachip.com) - 技术支持邮箱
