...
- A7T1的OTA Flash专门用于存储WiFi给语音升级的数据，仅用于语音固件升级
...
![智能家居控制面板应用场景](./img/1056f206.jpg)

![产品陈列展示墙](./img/db16e2d5.jpg)
...
![JX-A7T新一代AI大模型模块](./img/7c1a05c1.jpg)

![JX-A7T新品大模型模块](./img/e217fd2c.jpg)
...
## Q: JX-A7T模块是否支持WiFi、语音识别、语音播放、蓝牙功能？
...
## Q: JX-A7T模块中语音指令'What's your name'因包含特殊字符无法识别，如何解决？
...
## Q: JX-A7T模块是否支持语音识别后将识别结果以文字形式输出？
